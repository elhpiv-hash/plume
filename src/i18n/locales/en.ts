...
export const en: Dict = {
  ...
  'action.bookmarked': 'Remove from saved',
  ...
  'post.edit.title': 'Edit feather',
  'post.delete.action': 'Delete',
  'post.delete.title': 'Delete this feather?',
  'post.delete.body': 'This is forever — the feather and its replies will vanish.',
  ...
  'toast.bookmark.added': 'Saved',
  'toast.bookmark.removed': 'Removed from saved',
  'toast.post.edited': 'Feather updated',
  'toast.post.deleted': 'Feather deleted',
  ...
  'profile.saved.empty.title': 'Nothing saved yet',
  'profile.saved.empty.desc': 'Saved feathers show up here. Only you can see them.',
  'tab.posts': 'Posts',
  'tab.replies': 'Replies',
  'tab.saved': 'Saved',
